...
const agentPortraits: Record<string, string> = {
  ...
  "luna-moth": new URL("../video_picture/月蛾.png", import.meta.url).href,
...
const fallbackCompanionAgents: CompanionAgent[] = [
  ...
  },
  {
    ...
    style: "适合悬疑本与密室本",
    genius: ["悬念", "心理暗示", "节奏控制"],
    personality: ["神秘", "深沉", "善于暗示"],
    scriptTypes: ["恐怖本", "悬疑本", "密室本"],
    activeLevel: "低",
    playTime: "晚间",
    rating: 4.7,
    history: "历史协作 112 局",
    highlight: "悬念编织",
    oneliner: "在黑暗中编织故事，让每个角色都深陷其中",
    roleMatch: "适合悬念位、心理博弈位与暗线位",
    reason: "擅长制造悬念和逐步释放信息，让玩家沉浸其中。",
    isFavorited: false,
  },
  {
    key: "night-cicada",
